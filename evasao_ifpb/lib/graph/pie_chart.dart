...
class PieChartSample2 extends StatefulWidget {
  ...
  State<StatefulWidget> createState() => PieChart2State(
      nome == "Evasão" || nome == "Reprovou dois" ? [0xffDF0000,0xffFF3B1F] : [0xff006494,0xff1B98E0],
      valores,
      variaveis);
}
...
class PieChart2State extends State {
  ...
  List<int> coresAzul = [0xff006494,0xff1B98E0];
  List<int> coresVermelho = [0xffDF0000,0xffFF3B1F];
  List<int> cores;
  List<String> variaveis;
  List<int> valores;
