        ...
        child: Observer(builder: (_){
          return Column(
            children: [
              ...
              CustomTextField(labelText: 'CRE (0 - 100):', textEditingController: cre, onChanged: _metricsStore.setCre),
              ...
              const SizedBox(height: 20),
              CustomTextField(labelText: 'Distâcia de sua casa até o IFPB (em km):', textEditingController: distacia, onChanged: _metricsStore.setDistacia),
              const SizedBox(height: 20),
              CustomTextField(labelText: 'Índice CH (0 - 1) :', textEditingController: indice_ch, onChanged: _metricsStore.setIndice_ch),
              const SizedBox(height: 20),
              CustomTextField(labelText: 'Nota de Matemática do ENEM (0 - 1000):', textEditingController: m_enem, onChanged: _metricsStore.setM_enem),
              const SizedBox(height: 20),
              CustomTextField(labelText: 'Nota de Ciências da Natureza do ENEM (0 - 1000):', textEditingController: ch_enem, onChanged: _metricsStore.setCh_enem),
              const SizedBox(height: 20),
